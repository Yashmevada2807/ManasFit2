...
export const getAllResources = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    let filteredResources: { [key: string]: any[] } = { ...wellnessResources };
...
export const getResourceCategories = async (req: Request, res: Response): Promise<void> => {
  try {
    const categories = [
...
export const getSavedResources = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    user.resources.forEach((resourceId: string) => {
      Object.values(wellnessResources).forEach((resources: any) => {
